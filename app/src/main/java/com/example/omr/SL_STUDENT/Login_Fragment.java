...
public class Login_Fragment extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		sharedpref_list=new SHAREDPREF_LIST(getContext());
		if(!sharedpref_list.get_Student_rollno().equals("false")){
			Intent intent=new Intent(getActivity(),com.example.omr.RECORD.list_click_detail.class);
			startActivity(intent);
			sharedpref_list.setuser("STUDENT");
		}
		initViews();
		setListeners();
...
//		}
	...
	public void onClick(View v) {
		...
		case R.id.loginBtn:
			if(checkValidation()){
				Log.d("VALUES_CHECK", "onClick: here in");
				ref= FirebaseDatabase.getInstance().getReference("STUDENT");
				db=new todatabase(ref,getContext());
				db.Student_Signin(getEmailId,getPassword);
			}
			else {
				new CustomToast().Show_Toast(getActivity(), view,
						"Detail Entered Not Valid");
